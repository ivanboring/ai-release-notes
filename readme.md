...
6. Run the script to get release notes:
   ```bash
   php generate_release_notes.php copied_issues.txt ai 1.1.8
   ```
7. This will create a cache.json file to speed up future writing.
8. The release notes will be printed to the console. You need to specify project, previous version and if you want plain text for a release or html for the publishing - in this example we want plain text:
   ```bash
   php write_release_notes.php ai 1.1.7
   ```
9. When you are finished, you can delete the copied_issues.txt and cache.json files.
